...
public:
  ...
  {}
  Init_HardwareStatus_are_motors_ready temperature(::my_robot_interface::msg::HardwareStatus::_temperature_type arg)
  {
...
{
  return my_robot_interface::msg::builder::Init_HardwareStatus_temperature();
}
